...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 05, 2024 at 05:10 PM
...
--
-- Table structure for table `apartment_members`
--
...
CREATE TABLE `plot_info` (
  ...
  `help_line` varchar(15) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `role` int(11) NOT NULL DEFAULT 0 COMMENT 'prevalage setup',
  `status` int(11) NOT NULL DEFAULT 1 COMMENT 'active user'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `moobile`, `address_one`, `address_two`, `password`, `image`, `visited_at`, `created_at`, `role`, `status`) VALUES
(1, 'sabbir', 'admin@gmail.com', '01776678594', NULL, 'badda, dhaka', NULL, '$2y$10$lgLzOpkG6xiRYWvQrJWZkevJG0SgixsXfv6DEnsvLhqZI3I4AcJbG', 'stroage/img/1707149090466636651256-256-78c88a0658ef6a802112b3e1d76a3cbd.png', '2024-02-05 16:04:02', '2024-02-05 16:04:02', 2, 1);
...
CREATE TABLE `visitors` (
  ...
  `parsons` int(11) NOT NULL COMMENT 'number of visitors',
  `phone` varchar(15) NOT NULL,
...
--
-- Indexes for table `income_expence`
--
ALTER TABLE `income_expence`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `income_expence`
--
ALTER TABLE `income_expence`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `unions`
  ADD CONSTRAINT `unions_ibfk_2` FOREIGN KEY (`upazilla_id`) REFERENCES `upazillas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `upazillas`
--
ALTER TABLE `upazillas`
  ADD CONSTRAINT `upazillas_ibfk_2` FOREIGN KEY (`district_id`) REFERENCES `districts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
